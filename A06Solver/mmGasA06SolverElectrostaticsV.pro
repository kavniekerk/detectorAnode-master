...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/// MMGAS_STR_WIRE ELECTROSTATICS SOLVER MODULE

//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/// GENERAL INFORMATION
//
// mmgas_solver_electrostatics_v.pro
//
...
If(interactive)
  ...
  If(export)
    Printf('Include "mmgas_solver_add_material_database.pro";') >> Str[exportFile];
  EndIf
EndIf
...
If(interactive)
  ...
  EndFor
  If(export)
    Printf('Include "mmgas_solver_electrostatics_v.pro";') >> Str[exportFile];
  EndIf
EndIf
