...
dA03Mshlvl = 1.45*cA00MM;																														// mesh level, in mm
...
dA03PilAnSzxCo1a = ( dA02cpStrpWth/2 + dA02cpSpWth1/2 );																						// pillar anode size x 1a co-ordinate
...
For m In { 0:numA03PilUx }
 For n In { 0:numA03PilUy }
	...
	*/
	...
	// ptcA03Bd0pil0L2~{m}~{n} = newp; Point ( ptcA03Bd0pil0L2~{m}~{n} ) = { dA03PilCfx + cA03PilFx*cA03PilGeoFx*m, dA03PilCfy + cA03PilFy*cA03PilGeoFy*n, lvlA00cp2_0pil2cp12, lcA03pil1 };

	// circle

	// ptcA03Bd0pil0L2L1~{m}~{n} = newp; Point ( ptcA03Bd0pil0L2L1~{m}~{n} ) = { dA03PilCfx + cA03PilFx*cA03PilGeoFx*m - 1*( dA03PilR0 ), dA03PilCfy + cA03PilFy*cA03PilGeoFy*n, lvlA00cp2_0pil2cp12, lcA03pil1 };
	// ptcA03Bd0pil0L2B2~{m}~{n} = newp; Point ( ptcA03Bd0pil0L2B2~{m}~{n} ) = { dA03PilCfx + cA03PilFx*cA03PilGeoFx*m, dA03PilCfy + cA03PilFy*cA03PilGeoFy*n - 1*( dA03PilR0 ), lvlA00cp2_0pil2cp12, lcA03pil1 };
	// ptcA03Bd0pil0L2R3~{m}~{n} = newp; Point ( ptcA03Bd0pil0L2R3~{m}~{n} ) = { dA03PilCfx + cA03PilFx*cA03PilGeoFx*m + 1*( dA03PilR0 ), dA03PilCfy + cA03PilFy*cA03PilGeoFy*n, lvlA00cp2_0pil2cp12, lcA03pil1 };
	// ptcA03Bd0pil0L2T4~{m}~{n} = newp; Point ( ptcA03Bd0pil0L2T4~{m}~{n} ) = { dA03PilCfx + cA03PilFx*cA03PilGeoFx*m, dA03PilCfy + cA03PilFy*cA03PilGeoFy*n + 1*( dA03PilR0 ), lvlA00cp2_0pil2cp12, lcA03pil1 };
	*/
