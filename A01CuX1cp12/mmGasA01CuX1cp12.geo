...
/// UPPER COPPER CONDUCTOR LEVEL 1
//----------------------------------------------------------
...
volA01cpV1 = newv; Volume ( volA01cpV1 ) = { slA01cpSb1A[] }; // surfA03Bd0pil2L2l1A[]
...
physsurfA01cpSb1 = newreg; Physical Surface ( physsurfA01cpSb1 ) = { slA01cpSb1A[] }; // surfA03Bd0pil2L2l1A[]
...
physvolA01cpV1 = newreg; Physical Volume ( physvolA01cpV1 ) = { volA01cpV1 };
